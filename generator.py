...
class Generator:
    def generate_platform(platforms: Platform, player: Player, gravity):
        ...
        new_platform.x_coordinate = generate_platform_x_coordinate(player.max_jump_time(new_platform.y_coordinate, last_platform.y_coordinate, gravity), player.left_and_right_velocity, last_platform, new_platform)
